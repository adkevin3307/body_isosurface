...
void Transformation::init(CONSTANT::TRANSFORMATION type)
{
    switch (type) {
        case CONSTANT::TRANSFORMATION::MODEL:
            this->_model = glm::mat4(1.0);

            break;
        case CONSTANT::TRANSFORMATION::VIEW:
            this->_view = glm::mat4(1.0);

            break;
        case CONSTANT::TRANSFORMATION::PROJECTION:
            this->_projection = glm::mat4(1.0);

            break;
        case CONSTANT::TRANSFORMATION::MODEL_VIEW_PROJECTION:
            this->_model = glm::mat4(1.0);
            this->_view = glm::mat4(1.0);
            this->_projection = glm::mat4(1.0);
...
void Transformation::set_model(CONSTANT::TRANSFORMATION type, glm::vec3 v, float angle)
{
    switch (type) {
        case CONSTANT::TRANSFORMATION::TRANSLATE:
            this->_model = glm::translate(this->_model, v);

            break;
        case CONSTANT::TRANSFORMATION::SCALE:
            this->_model = glm::scale(this->_model, v);

            break;
        case CONSTANT::TRANSFORMATION::ROTATE:
